        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="flex-1 bg-gray-800 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-indigo-500/50"
            />
          </div>
          <div className="flex items-center gap-3">
            {/* Twitch icon */}
            ...
            <input
              ...
              className="flex-1 bg-gray-800 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-purple-500/50"
            />
          </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {twitch && (
            <a
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-gray-800 hover:bg-purple-500/10 rounded-lg text-sm transition-colors"
            >
              <svg className="w-4 h-4 text-purple-400 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714z" />
              </svg>
              <span className="text-purple-300 hover:text-purple-200">{twitch}</span>
            </a>
          )}
          {!hasAny && isOwn && (
            <p className="text-gray-600 text-sm italic">No socials added — click Edit to add Discord/Twitch.</p>
          )}
        </div>
      )}
